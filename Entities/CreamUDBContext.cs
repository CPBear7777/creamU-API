...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySQL("server=45.32.31.135;port=33060;user=CreamU;password=creamu133;database=CreamUDB");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CombineDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.CbodyNavigation)
                    .WithMany(p => p.CombineDetailCbodyNavigations)
                    .HasForeignKey(d => d.Cbody)
                    .HasConstraintName("FK_CombineDetail_CBody");

                entity.HasOne(d => d.CheadNavigation)
                    .WithMany(p => p.CombineDetailCheadNavigations)
                    .HasForeignKey(d => d.Chead)
                    .HasConstraintName("FK_CombineDetail_CHead");

                entity.HasOne(d => d.ClfootNavigation)
                    .WithMany(p => p.CombineDetailClfootNavigations)
                    .HasForeignKey(d => d.Clfoot)
                    .HasConstraintName("FK_CombineDetail_CLFoot");

                entity.HasOne(d => d.ClhandNavigation)
                    .WithMany(p => p.CombineDetailClhandNavigations)
                    .HasForeignKey(d => d.Clhand)
                    .HasConstraintName("FK_CombineDetail_CLHand");

                entity.HasOne(d => d.CrfootNavigation)
                    .WithMany(p => p.CombineDetailCrfootNavigations)
                    .HasForeignKey(d => d.Crfoot)
                    .HasConstraintName("FK_CombineDetail_CRFoot");

                entity.HasOne(d => d.CrhandNavigation)
                    .WithMany(p => p.CombineDetailCrhandNavigations)
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.Property(e => e.MessageContext).HasMaxLength(500);

                entity.Property(e => e.MessageTime).HasColumnType("datetime");

                entity.Property(e => e.ReplyContext).HasMaxLength(500);
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.Descript).HasMaxLength(500);

                entity.Property(e => e.ProductImage).HasMaxLength(50);

                entity.Property(e => e.ProductName).HasMaxLength(100);

                entity.Property(e => e.ProductStatus).HasMaxLength(30);

                entity.Property(e => e.ReleaseDate).HasMaxLength(30);

                entity.Property(e => e.Type).HasMaxLength(20);

                entity.Property(e => e.UpdatedDate).HasMaxLength(30);
